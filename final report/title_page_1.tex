...
O grupo considera que o trabalho foi desenvolvido de uma maneira saudável e todos os elementos do grupo trabalharam de forma igual (33.3\% para cada elemento). As melhorias a serem implementadas passariam por realizar mais testes por forma a perceber quais as condições que levariam a uma mehor otimização.%% Não concordo, o SA tá op mereço mais
